...
subq.l #12, %sp
movem.l %d7/%a2-%a3, (%sp)  /*Only %d7 is being used, so only it will be backed up*/
...
jsr iprintf             /*Print*/
move.l 32(%sp), (%sp)   /*Move Number of Entries into the stack*/
...
move.l 28(%sp), %d7     /*Counter for number of entries*/
...
jsr iprintf             /*Print*/
move.l 36(%sp), (%sp)   /*Move number of divisors to the stack*/
jsr value               /*Print number of divisors*/
pea NumDiv2             /* number(s) divisible by */
jsr iprintf             /*Print*/
move.l 32(%sp), (%sp)   /*Move divisor to the stack*/
...
/*Divisor list*/
move.l 32(%sp), %d7     /*Initialize the divisor counter*/
...
movem.l (%sp), %d7/%a2-%a3      /*Reload registers*/
addq.l #12, %sp
